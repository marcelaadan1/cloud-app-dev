...
![](../.gitbook/assets/ex3/image005.jpg)
...
{% hint style="info" %}
:memo: After you create the service, it takes a few minutes to be provisioned, as shown in the following figure. The status is “Provision in progress” for a while. If it takes too long for the status to change to “Provisioned”, refresh the browser.

![](../.gitbook/assets/ex3/image009.png)
...
![](../.gitbook/assets/ex3/image010.jpg)
...
![](../.gitbook/assets/ex3/image011.png)
...
![](../.gitbook/assets/ex3/image012.jpg)

![](../.gitbook/assets/ex3/image013.jpg)

![](../.gitbook/assets/ex3/image014.jpg)
...
![](../.gitbook/assets/ex3/image015.png)
...
![](../.gitbook/assets/ex3/image016.jpg)
...
![](../.gitbook/assets/ex3/image017.png)

* [ ] In the Docs tab, select **Learning Center** or alternatively, from another browser tab, go to the following address:
[https://developer.ibm.com/clouddataservices/docs/cloudant/](https://developer.ibm.com/clouddataservices/docs/cloudant/)

* [ ] In the IBM Cloudant Learning Center window, click **Load Data**, as shown in the following figure.

![](../.gitbook/assets/ex3/image018.png)
...
![](../.gitbook/assets/ex3/image023.png)

* [ ] Keep the default values that are shown in the window and click **Add**, as shown in the following figure.

![](../.gitbook/assets/ex3/image024.png)
{% hint style="info" %}
:memo: The Add new credential window includes the following fields: 
...
![](../.gitbook/assets/ex3/image025.png)
...
![](../.gitbook/assets/ex3/image026.png)
...
![](../.gitbook/assets/ex3/image027.jpg)

* [ ] Click **Launch Cloudant Dashboard**, as shown in the following figure.

![](../.gitbook/assets/ex3/image028.png)

* [ ] The Cloudant dashboard opens in a new browser tab, as shown in the following figure.

![](../.gitbook/assets/ex3/image029.png)

* [ ] Create a database and name it novels. Click **Create Database** on the top bar, as shown in the following figure.

![](../.gitbook/assets/ex3/image030.jpg)

* [ ] Name the database **novels**, select **Non-partitioned**, and then click **Create**, as shown in the following figure.

![](../.gitbook/assets/ex3/image031.jpg)

{% hint style="info" %}
:memo: While you are creating a database, there is the option to make the database partitioned. A partitioned database is a newer type of IBM Cloudant database. This option is an advanced feature, so it is out of the scope of this exercise. For more information about this topic, see the following link: 
https://cloud.ibm.com/docs/services/Cloudant/guides?topic=cloudant-database-partitioning#database-partitioning
{% endhint %}

* [ After you create the database, you are redirected to the new database overview, as shown in the following figure.

![](../.gitbook/assets/ex3/image032.png)

* [ ]Create a document for the “Oliver Twist” novel.  Click **Create Document**, as shown in the following figure.

![](../.gitbook/assets/ex3/image033.png)
...
![](../.gitbook/assets/ex3/image034.png)

{% hint style="info" %}
:memo: Note:   The ```_id``` field is automatically generated by Cloudant because it is considered the unique key identifier for the document. You can override this key by providing a _id with a unique value across the other documents.
{% endhint %}
...
```
![](../.gitbook/assets/ex3/image035.png)
...
![](../.gitbook/assets/ex3/image036.png)
...
![](../.gitbook/assets/ex3/image039.jpg)
...
![](../.gitbook/assets/ex3/image042.png)
...
![](../.gitbook/assets/ex3/image043.jpg)
...
![](../.gitbook/assets/ex3/image051.png)
...
![](../.gitbook/assets/ex3/image052.png)
...
![](../.gitbook/assets/ex3/image056.png)
...
![](../.gitbook/assets/ex3/image057.png)

* [ ] Copy the value of the access_token because it is used in all the upcoming requests.

% hint style="warning" %}
**Important**:   If the access_token expires while you make any of the upcoming requests, repeat step 2 to retrieve a new access token and use it instead of the old one.
{% endhint %}
...
![](../.gitbook/assets/ex3/image058.png)
...
![](../.gitbook/assets/ex3/image059.png)
...
* [ ] Open a new tab in Postman by clicking *+* in the top bar, as shown in the following figure. 

![](../.gitbook/assets/ex3/image062.png)
...
![](../.gitbook/assets/ex3/image063.png)
...
![](../.gitbook/assets/ex3/image066.png)
...
![](../.gitbook/assets/ex3/image067.png)
...
```
{% hint style="info" %}
:memo: The ```_id``` should be a unique identifier for the document. If the ```_id``` is not provided, Cloudant generates an ID.
{% endhint %}
...
![](../.gitbook/assets/ex3/image068.png)
...
![](../.gitbook/assets/ex3/image069.png)
...
![](../.gitbook/assets/ex3/image070.png)
...
![](../.gitbook/assets/ex3/image071.png)

* [ ] Click **Send**.

* [ ] Check the response that shows the ```_id``` and ```_rev``` fields to verify the creation of the new document, as shown in the following figure.

![](../.gitbook/assets/ex3/image072.png)
...
![](../.gitbook/assets/ex3/image073.png)
...
![](../.gitbook/assets/ex3/image074.png)
...
![](../.gitbook/assets/ex3/image075.png)
...
![](../.gitbook/assets/ex3/image078.png)
...
![](../.gitbook/assets/ex3/image079.png)
...
![](../.gitbook/assets/ex3/image082.png)
...
![](../.gitbook/assets/ex3/image083.png)
...
![](../.gitbook/assets/ex3/image086.png)
...
![](../.gitbook/assets/ex3/image087.png)
...
![](../.gitbook/assets/ex3/image088.png)
...
{% hint style="info" %}
:information_source: This is **information**.
% endhint %}

{% hint style="info" %}
::hourglass_flowing_sand: This is **wait until...**.
% endhint %}
...
% hint style="danger" %}
:exclamation: This is **danger** or **caution**
{% endhint %}
